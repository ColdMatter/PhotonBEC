...
//=============================================================================
//=============================================================================
// $Id: AdvCameraSettingsPage.h,v 1.17 2011-02-07 19:24:46 soowei Exp $
//=============================================================================
...
namespace FlyCapture2
{
	...
	private:
        ...
        static const char* sk_vboxPacketResend;
        static const char* sk_checkbuttonPacketResend;
        static const char* sk_spinbuttonPacketResendTimeout;
        static const char* sk_spinbuttonPacketResendMax;
        static const char* sk_buttonPacketResendSave;
        static const char* sk_buttonPacketResendLoad;
        ...
        // GigE packet resend
        Gtk::VBox* m_pVboxPacketResend;
        Gtk::CheckButton* m_pCheckbuttonPacketResend;
        ...
        Gtk::Adjustment* m_pAdjustmentPacketResendMax;
        Gtk::Button* m_pButtonPacketResendSave;
        Gtk::Button* m_pButtonPacketResendLoad;
        ...
        void OnPacketResendToggled();
        void OnPacketResendLoad();
