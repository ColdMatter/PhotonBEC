...
//=============================================================================
//=============================================================================
// $Id: Format7Page.h,v 1.31 2010/10/08 17:18:21 warrenm Exp $
//=============================================================================
...
namespace FlyCapture2
{
	...
	public:
        ...
        */
        ...
        /**  Update current settings for a running ladybug camera */
	...
	private:
        ...
        static const char* sk_labelJpegCompressionStatus;
        static const char* sk_hscaleJpegQuality;
        ...
        static const char* sk_labelResizeInformation;
        ...
        static const char* sk_buttonCenterROI;
		...
		sigc::connection m_sigctlPixelFormat;
		sigc::connection m_sigctlF7Left;
		sigc::connection m_sigctlF7Top;
		sigc::connection m_sigctlF7Width;
		sigc::connection m_sigctlF7Height;
        ...
        // JPEG compression
        Gtk::Label* m_pLabelJpegCompressionStatus;
        Gtk::HScale* m_pHscaleJpegQuality;
        Gtk::Adjustment* m_pAdjustmentJpegQuality;
        ...
        void PopulatePixelFormatComboBox( unsigned int pixelFormats, unsigned int vendorPixelFormats );
        ...
        void UpdateJpegInformation();

        void UpdateResizeInformation();
