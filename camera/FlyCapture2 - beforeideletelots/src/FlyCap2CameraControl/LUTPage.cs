...
namespace FlyCap2CameraControl
{
    ...
    internal partial class LUTPage : BasePage
    {
        ...
        private void InitializePage()
        {
            ...
            /*
             * This method seems like expired
             * 
            ...
            try
            {
                IIDC_Value = m_camera.ReadRegister(0x490);
            }
            catch
            {
                if (IIDC_Value != 0)
        ...
        {
            string initialFileName = m_camera.GetCameraInfo().serialNumber.ToString();
