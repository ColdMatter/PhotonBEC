...
selector=1
if selector==1:
	first_time,last_time = "122459", "123659"
	...
	spec_smooth=10
	rejected_parameter_values = [79, 87, 97, 104, 112, 123, 127, 134, 141]
...
par_vals = map(lambda x:x.meta.parameters["set_point"],ex_list)
...
for upv in unique_par_vals:
	selected_ex_list = filter(lambda x:x.meta.parameters["set_point"]==upv,ex_list)
