...
selector=4
if selector==1:
	first_time,last_time = "122132","123301"
elif selector==2:
	first_time,last_time = "131933","133709"
elif selector==3:
	first_time,last_time = "151353","151916"
elif selector==4:
	first_time,last_time = "152941","154116"
...
x0,y0= 395,600 #centre x0 and y0
...
fitting_spectra=True
fitting_images=True
mask_dx,mask_dy=35,35
...
for i in range(nvals):
	...
	if fitting_images:
		...
		#(fit_vals,fit_func) = fit_gaussian_to_image(display_im,maxfev=50)
		(fit_vals,fit_func,mask) = fit_gaussian_to_image_masked(display_im,mask_roi,maxfev=50)
		if plot_x:
...
if fitting_images:
	...
	grid(1)
	#title_str = first_ts+" to "+last_ts+"\n"
	title_str = ts_list[0]+" to "+ts_list[-1]+"\n"
	title_str += "Set point "+str(corr.meta.parameters["set_point"])+"; "
	title_str += "q = "+str(corr.meta.parameters["longitudinal_mode_number"])
	title(title_str)
