...
AOM_on, AOM_off = 0.9,0 #wrote 0.9 on 24/9/14
spectrometer_exposure_ms = 50 #Should saturate at highest power. Just.
...
rand_powers = powers#sample(powers,len(powers))
print('random powers = ' + str(rand_powers))
for p in rand_powers:
	lq.setPower(p)
