...
selector=3
if selector==1:
	first_time,last_time = "101807","102821"
	background_subtraction = 0.95
	colour_weights = (1,1,0,0)
	leastsq_range_adjust = -15,11 #wavelength range for fitting, in nm
	xlimits=(530,622) #for spectra
	ylimits=(1e5,1e9)
	x0,y0= 400,600 #centre x0 and y0
	dx,dy= 150,150 #half-size of roi dx and dy
	spec_smooth=10
	rejected_parameter_values = [70,80,90]
if selector==2:
	first_time,last_time = "135359","140044"
	background_subtraction = 0.95
	colour_weights = (1,1,0,0)
	leastsq_range_adjust = -15,11 #wavelength range for fitting, in nm
	xlimits=(530,622) #for spectra
	ylimits=(1e5,1e9)
	x0,y0= 450,650 #centre x0 and y0
	dx,dy= 220,220 #half-size of roi dx and dy
	spec_smooth=10
	rejected_parameter_values = []
if selector==3:
	first_time,last_time = "145926","151101"
	background_subtraction = 0.95
	colour_weights = (1,1,0,0)
	...
	dx,dy= 220,220 #half-size of roi dx and dy
	spec_smooth=10
	rejected_parameter_values = [140, 180, 210]
if selector==4:
	first_time,last_time = "180658","181507"
	background_subtraction = 0.98
	colour_weights = (1,1,0,0)
	leastsq_range_adjust = -20,6 #wavelength range for fitting, in nm
	xlimits=(530,622) #for spectra
	ylimits=(5e4,3e6) #for spectra
	x0,y0= 450,650 #centre x0 and y0, image
	dx,dy= 220,220 #half-size of roi dx and dy
	spec_smooth=10
	rejected_parameter_values = [90,100,110,140]	
...
if spot_size_check:
	...
	ss_filename = timestamp_to_filename(spot_size_ts,file_end="_spot_size.png")
