...
selector=2
if selector==1:
	first_time,last_time = "094325","095157"
	background_subtraction = 0.5 #poor!
	colour_weights = (1,0,0,0)
	leastsq_range_adjust = -25,10 #wavelength range for fitting, in nm
	xlimits=(540,622) #for spectra
	ylimits=(3e6,1e9)
	x0,y0= 400,600 #centre x0 and y0
	dx,dy= 350,350 #half-size of roi dx and dy
	spec_smooth=10
if selector==2:
	first_time,last_time = "125323","130017"
