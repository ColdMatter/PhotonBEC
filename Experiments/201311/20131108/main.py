...
nd_filter = 1
timebase=250e-9
micrometer_posn_mm = 12.5
parameter_extra = {"micrometer_posn_mm":micrometer_posn_mm}

comment_extra = "Ringdown. Cavity micrometer posn = "+str(micrometer_posn_mm)+"; Detector Analog Modules 712A-4 APD; RoC 0.5 m and RoC 4.0 m"
saving=True
