...
class MetaData():
	def __init__(self, ts=None, parameters={}, comments=""):
		if ts==None:
			ts = make_timestamp()
		self.ts = ts
	...
	def save(self):
		d = {"ts":self.ts, "parameters":self.parameters, "comments":self.comments}
