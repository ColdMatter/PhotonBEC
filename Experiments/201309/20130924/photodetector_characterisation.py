...
nd_filter=float(raw_input("ND FILTERS IN BEAM, DIVIDE BY \n"))

title_comment = "PD gain "+str(PDgain_dB)+" dB; Laser power "+str(laser_power)+" mW; ND filter" + str(nd_filter)
...
for i in range(Nruns-1):
	...
	parameters = {"laser power":laser_power,\
		"Navg scope":Navg,"Nruns":count,"PDgain_dB":PDgain_dB,\
