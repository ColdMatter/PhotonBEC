...
1. Install Python. Currently we support Python 2.7, 3.5, 3.6, and 3.7. To
...
2. (Optional) Set the PATH environment variable for your Python installation.
   ...
   if you installed Python at C:\Python37\, you would add the following entry
   to the PATH variable:

   C:\Python37\<rest_of_path>
...
3. Configure your Python installation. From a command line, run the following
   ...
   of our examples to highlight possible usages of PySpin.
...
5. Run the following command to install PySpin to your associated Python version.
   ...
   <python version> -m pip install spinnaker_python-1.x.x.x-cp37-cp37m-win_amd64.whl
...
For example, if PySpin is installed for Python 3.7 you can run a preinstalled example
using the following:

   ex. py -3.7 Examples\Python3\Acquisition.py
...
4. Install wheel for specific Python version. This can be installed site-wide
   ...
   sudo python3.7 -m pip install spinnaker_python-1.x.x.x-cp37-cp37m-linux_x86_64.whl

   - Python 3.7, user only:
   python3.7 -m pip install --user spinnaker_python-1.x.x.x-cp37-cp37m-linux_x86_64.whl
...
5. Install the PySpin wheel for specific Python version.
   ex. sudo python3.7 -m pip install spinnaker_python-1.x.x.x-cp37-cp37mu-macos_x86_x64.whl" for 64-bit Python 3.7
