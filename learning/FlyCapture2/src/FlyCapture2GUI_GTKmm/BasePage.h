...
//=============================================================================
//=============================================================================
// $Id: BasePage.h,v 1.30 2010/10/28 23:22:33 hirokim Exp $
//=============================================================================
...
namespace FlyCapture2
{
	...
	protected:
		...
		/** Checks if the packet resend is supported. */
		bool IsPacketResendSupported();

        /** Checks if the camera is one of the Ladybug models*/
        bool IsLadybug();
        bool IsLadybug2();
        bool IsLadybug3();
        ...
        /**
         * Check whether the page should be updated.
         *
         * @return Whether the page should be updated.
         */ 
