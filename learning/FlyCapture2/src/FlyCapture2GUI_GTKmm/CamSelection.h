...
//=============================================================================
//=============================================================================
// $Id: CamSelection.h,v 1.34 2010/03/23 22:53:18 soowei Exp $
//=============================================================================
...
{      	  
	...
	public:
         ...
         * @param serialNumber Serial number related to bus reset - should be zero.
         */
		 ...
		 *
		 * @param pTitle Null-terminated string representing the title.
		 */
	...
	private:
        ...
        static const char* sk_buttonAutoForceIP;
        ...
        static const char* sk_labelDriverName;
        ...
        Gtk::Button* m_pButtonAutoForceIP;
         ...
         * camera information.
		 *
		 * @param guid PGRGuid of camera to populate dialog with.
		 */
