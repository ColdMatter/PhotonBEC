...
namespace FlyCap2CameraControl
{
    ...
    internal partial class CameraSelectionWindow : Form
    {
        ...
        private void PopulateCameraList()
        {
            ...
            CameraInfo[] discoveredCameras = ManagedBusManager.DiscoverGigECameras();
        ...
        private void OnForceIpButtonClick(object sender, EventArgs e)
        {
            ...
            DialogResult result = MessageBox.Show(
                "This will set all GigE cameras discovered to an IP configuration that will allow it to work with FlyCapture2." +
                Environment.NewLine +
