        ...
        private void OnMainTabControlSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (m_mainTabControl.SelectedIndex)
            {
                case 1:
                    ...
                    {
                        Debug.WriteLine("Page 1 is not Camera Infomation Page.");
                        Debug.WriteLine(ex);
                        return;
                    }
                ...
                case 6:
                    try
                    {
                        ((AdvCameraSettingsPage)m_pages[6]).UpdateMemoryChannelButtons();
                    }
                    catch (InvalidCastException ex)
                    {
                        Debug.WriteLine("Page 6 is not Advanced Camera Settings Page.");
                        Debug.WriteLine(ex);
                        return;
                    }
