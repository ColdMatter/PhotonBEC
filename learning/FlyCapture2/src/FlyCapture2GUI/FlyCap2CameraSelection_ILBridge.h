...
{
    class ILBridge_CameraSelectionDialog 
    {    
    public:
        ILBridge_CameraSelectionDialog();         
        ~ILBridge_CameraSelectionDialog() {}
        
        void ShowModal(bool* pOk, FlyCapture2::PGRGuid* pGuid, unsigned int* pSize);        
        void SetTitle(const wchar_t* title);

    private:
        gcroot<FlyCapture2Managed::Gui::CameraSelectionDialog^> m_pCamSelDialog;
    };
}
