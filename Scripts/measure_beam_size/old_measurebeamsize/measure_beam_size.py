...
magnification = 3.4 #imaging system magnification. Measured 4/8/14
...
x0,y0=450,630 #defines center of subimage search area
...
for i in range(number_of_cycles):
	...
	if auto_guess: 
		...
		#
	fig,pars_fit = fit_and_plot(im_raw,ts,x0,y0,dx,dy,px,maxfev=200,colour_weights=(1,0,0))
